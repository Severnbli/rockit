...
using _Project.Scripts.Runtime.Features.Economy.Coins.Tags;
...
namespace _Project.Scripts.Runtime.Features.Economy.Coins
{
    public sealed class CoinsAspect : ProtoAspectInject
    {
        ...
        public readonly ProtoPool<CoinsTotalizerTag> CoinsTotalizerTagPool;
        ...
        public readonly ProtoIt CoinsTotalizerTextUis = new (It.Inc<CoinsTotalizerTag, TextUiComponent>());
    }
}