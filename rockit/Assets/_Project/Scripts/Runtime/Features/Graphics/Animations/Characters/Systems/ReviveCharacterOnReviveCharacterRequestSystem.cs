...
{
    public sealed class ReviveCharacterOnReviveCharacterRequestSystem : IProtoInitSystem, IProtoRunSystem
    {
        ...
        public ReviveCharacterOnReviveCharacterRequestSystem(CharacterAnimationConfig caConfig)
        {
            _caConfig = caConfig;
        }
        ...
        public void Run()
        {
            foreach (var reqE in _carAspect.ReviveCharacterRunRequests)
            {
                ...
                aComponent.Animator.SetBool(_caConfig.DeadBool, false);
            }
        }
    }
}