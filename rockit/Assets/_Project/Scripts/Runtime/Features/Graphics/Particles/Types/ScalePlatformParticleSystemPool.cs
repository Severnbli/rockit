...
{
    public class ScalePlatformParticleSystemPool : ParticleSystemPool
    {
        private readonly PlatformParticlesConfig _ppConfig;
        
        public ScalePlatformParticleSystemPool(ProtoWorld world, ParticleSystemsContainer psContainer, 
            PlatformParticlesConfig ppConfig) : base(world, psContainer)
        {
            _ppConfig = ppConfig;
        }

        protected override GameObject GetPrefab() => _ppConfig.ScalePrefab;
    }
}