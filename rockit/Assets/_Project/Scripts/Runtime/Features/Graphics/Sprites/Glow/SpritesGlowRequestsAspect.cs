...
namespace _Project.Scripts.Runtime.Features.Graphics.Sprites.Glow
{
    ...
    {
        public readonly ProtoPool<SpriteGlowChangeCompletedRequest> SpriteGlowChangeCompletedRequestPool; 
        public readonly ProtoIt SpriteGlowChangeCompletedRequests = new (It.Inc<RequestComponent, ActiveRequestTag, RunRequestTag, SpriteGlowChangeCompletedRequest>());
    }
}