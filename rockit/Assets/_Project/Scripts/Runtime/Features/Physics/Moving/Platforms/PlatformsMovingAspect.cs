...
namespace _Project.Scripts.Runtime.Features.Physics.Moving.Platforms
{
    public class PlatformsMovingAspect : ProtoAspectInject
    {
        ...
        public readonly ProtoIt PositionChangableRigidbodyPlatforms = new (It.Inc<PlatformPositionChangeComponent, Rigidbody2DComponent>());
        public readonly ProtoIt RotationChangableRigidbodyPlatforms = new (It.Inc<PlatformRotationChangeComponent, Rigidbody2DComponent>());
        public readonly ProtoIt ScaleChangableRigidbodyPlatforms = new (It.Inc<PlatformScaleChangeComponent, Rigidbody2DComponent>());
    }
}