...
namespace _Project.Scripts.Runtime.Features.Physics.Shared
{
    public sealed class PhysicsSharedAspect : ProtoAspectInject
    {
        ...
        public readonly ProtoPool<CollisionEnterComponent> CollisionEnterComponentPool;
        ...
        public readonly ProtoIt CollisionEnters = new (It.Inc<CollisionEnterComponent>());
    }
}