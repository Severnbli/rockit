...
{
    public sealed class SendEnablePlayerRequestOnLevelSpawnedRequestSystem : IProtoInitSystem, IProtoRunSystem
    {
        ...
        public void Run()
        {
            ...
            foreach (var e in _pAspect.Players)
            {
                ...
                SharedUtils.CreateEnableRequest(_rAspect, packed);
            }
        }
    }
}